...
const (
	pubKey  = "signing/release_signer/signer/test_data/pub.gpg"
	secKey  = "signing/release_signer/signer/test_data/sec.gpg"
	testTxt = "signing/release_signer/signer/test_data/test.txt"
	badTxt  = "signing/release_signer/signer/test_data/bad.txt"
)
